...
public class MessageGrouperTests
{
    ...
    public void Same_author_within_5_minutes_no_header()
    {
        var prev = At(12, 0);
        var curr = At(12, 4);
        Assert.False(MessageGrouper.ShouldShowAuthor(prev, AuthorA, curr, AuthorA));
    }
    ...
    public void Same_author_after_5_minutes_shows_header()
    {
        var prev = At(12, 0);
        var curr = At(12, 5);
        Assert.True(MessageGrouper.ShouldShowAuthor(prev, AuthorA, curr, AuthorA));
    }
    ...
    public void Different_author_same_minute_shows_header()
    {
        var prev = At(12, 0);
        var curr = At(12, 0);
        Assert.True(MessageGrouper.ShouldShowAuthor(prev, AuthorA, curr, AuthorB));
    }
    ...
    {
        Assert.True(MessageGrouper.ShouldShowAuthor(null, null, At(12, 0), AuthorA));
        Assert.False(MessageGrouper.ShouldShowTimeSeparator(null, At(12, 0)));
    }
    ...
    public void New_day_shows_separator()
    {
        var prev = At(12, 0, day: 1);
        var curr = At(12, 0, day: 2);
        Assert.True(MessageGrouper.ShouldShowTimeSeparator(prev, curr));
    }
    ...
    public void Same_day_no_separator()
    {
        var prev = At(9, 0);
        var curr = At(17, 0);
        Assert.False(MessageGrouper.ShouldShowTimeSeparator(prev, curr));
    }
}
