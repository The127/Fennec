<p align="center">
  <img src="Fennec.App/Assets/logo.png" width="80" alt="Fennec logo" />
</p>
...
<p align="center">
  <a href="https://github.com/The127/Fennec/releases/latest">Download</a> ·
  <a href="docs/Developing.md">Contributing</a> ·
  <a href="docs/Federation.md">Federation</a>
</p>
...
Fennec is a self-hostable chat platform with voice, built for communities that don't want to hand their data over to a corporation. Think Discord — channels, servers, voice calls — but where anyone can run their own instance, and those instances can talk to each other.
...
Grab the latest desktop client from the [releases page](https://github.com/The127/Fennec/releases/latest) and connect to an existing server, or host your own.

- [Setting up a server](docs/Hosting.md) *(TBD)*
- [Federation explained](docs/Federation.md) *(TBD)*
- [Building from source](docs/Developing.md)

## Contributing

Fennec is early. There is plenty of room to help — bug reports, feature ideas, and pull requests are all welcome. See [docs/Developing.md](docs/Developing.md) for how to get the project running locally.
